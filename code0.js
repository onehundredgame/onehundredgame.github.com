...
gdjs.LevelCode.GDDinoDouxObjects1= [];
gdjs.LevelCode.GDDinoDouxObjects2= [];
gdjs.LevelCode.GDDinoDouxObjects3= [];
gdjs.LevelCode.GDDinoDouxObjects4= [];
gdjs.LevelCode.GDDinoDouxObjects5= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16119116);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16156684);
}
}
if (isConditionTrue_0) {
...
};gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects2Objects = Hashtable.newFrom({"Player2": gdjs.LevelCode.GDPlayer2Objects2});
...
gdjs.copyArray(runtimeScene.getObjects("Player2"), gdjs.LevelCode.GDPlayer2Objects3);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDPlayer2Objects3.length;i<l;++i) {
    if ( gdjs.LevelCode.GDPlayer2Objects3[i].getBehavior("PlatformerObject").isJumping() ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15985948);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__Player__IsSteppingOnFloor.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects2Objects, "PlatformerObject", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDDustParticleObjects2Objects, (( gdjs.LevelCode.GDPlayer2Objects2.length === 0 ) ? 0 :gdjs.LevelCode.GDPlayer2Objects2[0].getAABBCenterX()), (( gdjs.LevelCode.GDPlayer2Objects2.length === 0 ) ? 0 :gdjs.LevelCode.GDPlayer2Objects2[0].getAABBBottom()), "");
...
gdjs.copyArray(runtimeScene.getObjects("Player2"), gdjs.LevelCode.GDPlayer2Objects3);
{gdjs.evtsExt__Checkpoints__SaveCheckpoint.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayerObjects3Objects, (( gdjs.LevelCode.GDPlayer2Objects3.length === 0 ) ? 0 :gdjs.LevelCode.GDPlayer2Objects3[0].getPointX("")), (( gdjs.LevelCode.GDPlayer2Objects3.length === 0 ) ? 0 :gdjs.LevelCode.GDPlayer2Objects3[0].getPointY("")), "Checkpoint", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects2Objects, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDCoinObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects2Objects, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDFlyObjects2Objects, false, runtimeScene, false);
}
if (isConditionTrue_0) {
...
};gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects1Objects = Hashtable.newFrom({"Player2": gdjs.LevelCode.GDPlayer2Objects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects1Objects, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDMonsterObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15756468);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects2Objects, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPortalObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15775468);
}
}
if (isConditionTrue_0) {
...
{gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.func(runtimeScene, 0, "Sound", gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPortalObjects1Objects, gdjs.LevelCode.mapOfGDgdjs_46LevelCode_46GDPlayer2Objects1Objects, 0, 20, 750, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
gdjs.LevelCode.GDDinoDouxObjects1.length = 0;
gdjs.LevelCode.GDDinoDouxObjects2.length = 0;
gdjs.LevelCode.GDDinoDouxObjects3.length = 0;
gdjs.LevelCode.GDDinoDouxObjects4.length = 0;
gdjs.LevelCode.GDDinoDouxObjects5.length = 0;
